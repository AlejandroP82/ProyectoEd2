package com.example.caminocorto;
...
import com.example.caminocorto.Utils.GPS_controller;
import com.example.caminocorto.Utils.Utils;
...
public class MapaInicio extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener, GoogleMap.OnMapClickListener, GoogleMap.OnMarkerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gpsTracker = new GPS_controller(getApplicationContext());
...
LatLng we=new LatLng(-17.849640,-63.250285);

nMap.animateCamera(CameraUpdateFactory.newLatLngZoom(we,10),5000,null);
...
Utils.coordenadas.setDestinoLat(latLng.longitude);
        Toast.makeText(MapaInicio.this, "toque icono para selecciones", Toast.LENGTH_SHORT).show();
    }
    ...
    public void ObtenerRuta(String latInicial, String lngInicial, String latFinal, String lngFinal){
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/json?origin=" + latInicial + "," + lngInicial + "&destination=" + latFinal + "," + lngFinal + "&key=AIzaSyA-05CqUFRZT6a2D-p5OMB6CEKUfp37oH4mode=drive";
